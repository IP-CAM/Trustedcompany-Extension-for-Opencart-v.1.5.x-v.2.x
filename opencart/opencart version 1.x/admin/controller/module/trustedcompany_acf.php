...
class ControllerModuleTrustedcompanyacf extends Controller {
	...
	public function index() {
		...
		$this->data['texte_add_email'] 		= $this->language->get('texte_add_email');
		$this->data['texte_dns'] 		= $this->language->get('texte_dns');
		$this->data['text_acf'] 		= $this->language->get('text_acf');
